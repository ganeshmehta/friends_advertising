...
export default function AboutPage() {
  return (
    <main className="flex flex-col w-full overflow-hidden pt-10 pb-20">
      {/* Hero Section */}
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="p-4 rounded-xl border-l-4 border-[var(--neon-blue)] bg-white/5">
            <p className="text-[var(--neon-blue)] font-medium text-lg italic">
        ...
        >
          {[
            ...
            <div key={i} className="glass p-6 rounded-2xl flex flex-col items-center justify-center text-center hover:neon-border transition-all duration-300">
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">CLIENT <span className="text-[var(--neon-purple)]">TESTIMONIALS</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((t, i) => (
              <motion.div 
                ...
                className="glass p-8 rounded-3xl relative overflow-hidden group hover:neon-border transition-all duration-500"
              >
                <Quote className="absolute -top-4 -right-4 w-24 h-24 text-white/5 group-hover:text-[var(--neon-purple)]/10 transition-colors" />
                <p className="text-gray-300 italic mb-6 relative z-10 leading-relaxed text-lg">
                  "{t.quote}"
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[var(--neon-blue)] to-[var(--neon-purple)] flex items-center justify-center font-bold text-xl">
                    {t.name[0]}
                  </div>
                  <div>
                    <h4 className="font-bold text-[var(--neon-blue)]">{t.name}</h4>
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-gray-500">Trusted by leading media houses and hospitality brands</p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {partners.map((partner, i) => (
              <motion.div
                ...
                className="px-6 py-3 rounded-full glass border border-white/10 text-sm font-medium hover:bg-[var(--neon-blue)]/10 hover:border-[var(--neon-blue)]/50 transition-all cursor-default"
              >
                {partner}
              </motion.div>
            ))}
      ...
      <section className="py-20 px-4 relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div {...fadeInUp} className="text-center mb-16">
            ...
            <p className="text-gray-500">Empowering the skyline with iconic outdoor presence</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {realEstateClients.map((client, i) => (
              <motion.div
                ...
                className="aspect-square flex items-center justify-center text-center p-4 glass rounded-2xl text-[10px] md:text-xs font-bold uppercase tracking-tighter hover:neon-border hover:scale-105 transition-all group"
              >
                <span className="group-hover:text-[var(--neon-blue)] transition-colors">{client}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 text-center">
        <motion.div 
          {...fadeInUp}
          className="max-w-3xl mx-auto glass p-12 rounded-[3rem] border-2 border-white/5 relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-[var(--neon-blue)]/5 to-[var(--neon-purple)]/5"></div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative z-10">READY TO <span className="neon-text">STAND OUT?</span></h2>
          <p className="text-gray-400 mb-8 relative z-10">Let's discuss your next campaign and make your brand unforgettable.</p>
          <motion.button 
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-[var(--neon-blue)] to-[var(--neon-purple)] rounded-full font-bold text-black relative z-10 shadow-[0_0_20px_rgba(0,243,255,0.4)]"
          >
            GET IN TOUCH
          </motion.button>
        </motion.div>
